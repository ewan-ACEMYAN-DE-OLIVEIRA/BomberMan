...
public class CaptureTheFlagController {
    ...
    // --- FXML nodes (identique à game.fxml) ---
    ...
    public void initialize() {
        // Charge assets
        pelouseImg      = loadAsset("asset_base", "pelouse.png");
        wallImg         = loadAsset("asset_base", "wall.png");
        destructibleImg = loadAsset("asset_base", "destructible.png");
        flagImg         = safeLoad("/images/flag.png");
        bombImg         = loadAsset("asset_base", "bomb.png");
        explosionImg    = loadAsset("asset_base", "explosion.png");
